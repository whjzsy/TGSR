...
parser.add_argument('--model_save_name', default ='SiamRPN++',
...
if __name__ == '__main__':
    ...
    main(traj_checkpoint ='../snapshot_test/otb_traj.pth',
         iou_checkpoint='../snapshot_test/otb_iounet_checkpoint_e5.pth',
         refine_checkpoint='../snapshot_test/otb_refine_checkpoint_e5.pth')
